...
public class BaseCoordinateSystem extends View {
    ...
    static class SavedState extends BaseSavedState {
        ...
        public void writeToParcel(Parcel out, int flags) {
            ...
            out.writeByte((byte) (this.isShowDivisionAbscissaAxis ? 1 : 0));
            out.writeByte((byte) (this.isShowDivisionOrdinateAxis ? 1 : 0));
            ...
            out.writeByte((byte) (this.isAbscissaInCenter ? 1 : 0));
            out.writeByte((byte) (this.isOrdinateInCenter ? 1 : 0));
            out.writeInt(this.stepDivisionsAbscissaAxis);
            out.writeInt(this.stepDivisionsOrdinateAxis);
            out.writeByte((byte) (this.isHorizontalScroll ? 1 : 0));
            out.writeByte((byte) (this.isVerticalScroll ? 1 : 0));
            out.writeByte((byte) (this.isScaling ? 1 : 0));
